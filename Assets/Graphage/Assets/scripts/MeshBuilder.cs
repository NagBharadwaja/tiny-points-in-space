...
public class MeshBuilder
{
	...
	public List<bool> Render { get { return m_Render; } }
	private List<bool> m_Render = new List<bool> ();
	...
	public Mesh CreateMesh()
	{
		...
		//for (int i = 0; i<mesh.vertices.Length; i++) {
			//colors[i]=new Color((mesh.vertices[i].normalized.x),(mesh.vertices[i].normalized.z),mesh.vertices[i].normalized.y);
			//MonoBehaviour.print(colors[i]);
		//}
		if (m_Colors.Count > 1) {
