...
using System;
	...
	public class GraphData : MonoBehaviour {
		...
		private float minZ;  // lower range for Z
		private float maxZ;  // upper range for Z
		...
		private float z;
		private int editVar;  //variable used to determine what is being edited using the circle menus;
